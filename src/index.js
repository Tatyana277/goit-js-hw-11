...
refs.form.style =
  'background-color: #7b68ee; display: flex; justify-content: center; padding: 8px; margin-bottom: 8px; position: fixed; top: 0; z-index: 99; width: 100%';
...
function createImageEl(hits) {
  ...
  refs.loadMoreBtn.style =
    ' display: flex;  margin-left: auto;  margin-right: auto; margin-bottom:32px; margin-top:32px; padding:16px; border: 1px solid green; border-radius:4px; color: #006400; background-color: salad';
  refs.goUpBtn.style =
    'position: fixed; bottom: 32px;right: 32px; border-radius: 20%; width: 80px; height: 40px; background-color: #7fffd4; color: blue; border: 1px solid blue';
}
